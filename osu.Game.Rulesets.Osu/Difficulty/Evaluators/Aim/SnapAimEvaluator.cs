    ...
    public static class SnapAimEvaluator
    {
        ...
        public static double EvaluateDifficultyOf(DifficultyHitObject current, bool withSliderTravelDistance)
        {
            ...
            if (osuCurrObj.Angle != null && osuLastObj.Angle != null)
            {
                ...
                double wideAngleBase = (1 * DifficultyCalculationUtils.Smootherstep(prevDistance, radius, diameter)) / Math.Pow(osuCurrObj.AdjustedDeltaTime, 2);
            ...
            aimStrain += wideAngleBonus * 18500;
            aimStrain += velocityChangeBonus * velocity_change_multiplier;

            // Add in additional slider velocity bonus.
            if (withSliderTravelDistance)
                aimStrain += (sliderBonus < 1 ? sliderBonus : Math.Pow(sliderBonus, 0.75)) * 1.15;

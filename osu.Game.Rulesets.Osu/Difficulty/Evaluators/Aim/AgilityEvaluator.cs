    ...
    public static class AgilityEvaluator
    {
        ...
        public static double EvaluateDifficultyOf(DifficultyHitObject current)
        {
            ...
            if (osuCurrObj.Angle != null && osuPrevObj.Angle != null && osuPrev1Obj.Angle != null)
            {
                ...
                double angleBonus = 0.35 * DifficultyCalculationUtils.Smootherstep(currentAngle, 40, 180) * currDistanceMultiplier * prevDistanceMultiplier;
                ...
                agilityBonus += Math.Max(0, osuCurrObj.SmallCircleBonus - 1) * 0.25;
            }
        ...
        private static double vectorAngleRepetition(OsuDifficultyHitObject current, OsuDifficultyHitObject previous)
        {
            ...
            double baseNerf = 1 - 0.5 * SnapAimEvaluator.CalcAcuteAngleBonus(lastAngle) * angleDifferenceAdjusted;

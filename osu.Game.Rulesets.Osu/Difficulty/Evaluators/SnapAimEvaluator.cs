...
namespace osu.Game.Rulesets.Osu.Difficulty.Evaluators
{
    public static class SnapAimEvaluator
    {
        public static double EvaluateDifficultyOf(DifficultyHitObject current, bool withSliderTravelDistance, bool withCheesability)
        {
            ...
            double difficulty = EvaluateDistanceBonus(current, withSliderTravelDistance, withCheesability) * 14.65;
            double sliderBonus = 0;
            //difficulty += EvaluateAgilityBonus(current) * 65;
            difficulty += EvaluateAngleBonus(current) * 10.2;
            difficulty += EvaluateVelocityChangeBonus(current) * 8;
        ...
        public static double EvaluateAgilityBonus(DifficultyHitObject current)
        {
            ...
            double baseBpm = 320.0 / (1 + 0.35 * Smootherstep(currentAngle, 0, 120) * currDistanceMultiplier * prevDistanceMultiplier);

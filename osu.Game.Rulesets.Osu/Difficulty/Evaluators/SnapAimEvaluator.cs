    ...
    public static class SnapAimEvaluator
    {
        ...
        public static double EvaluateDifficultyOf(DifficultyHitObject current, bool withSliderTravelDistance, bool withCheesability)
        {
            ...
            if (osuLastObj.BaseObject is Slider && withSliderTravelDistance)
            {
                ...
                currVelocity = Math.Max(currVelocity, movementVelocity + travelVelocity * 0.6); // take the larger total combined velocity.
            }
            ...
            aimStrain += wideAngleBonus * wide_angle_multiplier + velocityChangeBonus * velocity_change_multiplier;

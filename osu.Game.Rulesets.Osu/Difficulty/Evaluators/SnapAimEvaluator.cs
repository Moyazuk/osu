    ...
    public static class SnapAimEvaluator
    {
        ...
        public static double EvaluateDifficultyOf(DifficultyHitObject current, bool withSliderTravelDistance)
        {
            ...
            if (osuCurrObj.Angle != null && osuLastObj.Angle != null && osuLastLastObj.Angle != null)
            {
                ...
                wideAngleBase /= Math.Pow(Math.Max(osuLastObj.AdjustedDeltaTime, osuCurrObj.AdjustedDeltaTime), 1.25);
            ...
            bonuses += velocityChangeBonus * 0.1;

            // Add in acute angle bonus or wide angle bonus, whichever is larger.
            bonuses += wideAngleBonus * 150;
        ...
        public static double CalculateSliderBonus(OsuDifficultyHitObject osuCurrObj)
        {
            if (osuCurrObj.BaseObject is Slider)
            {
                ...
                // Add high bpm bonus
                sliderBonus *= highBpmBonus(osuCurrObj.AdjustedDeltaTime, osuCurrObj.TravelDistance);

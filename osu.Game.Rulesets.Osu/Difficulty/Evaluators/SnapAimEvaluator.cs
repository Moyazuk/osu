...
namespace osu.Game.Rulesets.Osu.Difficulty.Evaluators
{
    public static class SnapAimEvaluator
    {
        public static double EvaluateDifficultyOf(DifficultyHitObject current, bool withSliderTravelDistance)
        {
            ...
            double difficulty = EvaluateDistanceBonus(current, withSliderTravelDistance) * 78;
            double sliderBonus = 0;
            //difficulty += EvaluateAgilityBonus(current) * 65;
            difficulty += EvaluateAngleBonus(current) * 62;
            difficulty += EvaluateVelocityChangeBonus(current) * 184;
        ...
        public static double EvaluateAgilityBonus(DifficultyHitObject current)
        {
            ...
            double baseBpm = 240.0 / (1 + 0.55 * Smootherstep(currentAngle, 0, 120) * currDistanceMultiplier * prevDistanceMultiplier);

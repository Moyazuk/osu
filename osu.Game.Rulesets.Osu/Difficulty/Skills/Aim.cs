...
namespace osu.Game.Rulesets.Osu.Difficulty.Skills
{
    ...
    public class Aim : OsuStrainSkill
    {
        ...
        private double skillMultiplierAim => 79.92;
        ...
        protected override double StrainValueAt(DifficultyHitObject current)
        {
            ...
            double snapDifficulty = AimEvaluator.EvaluateDifficultyOf(current, IncludeSliders);
            double flowDifficulty = FlowAimEvaluator.EvaluateDifficultyOf(current, IncludeSliders);

            double aimDifficulty = Math.Min(snapDifficulty, flowDifficulty);
            ...
            double totalStrain = currentAimStrain * skillMultiplierTotal;
